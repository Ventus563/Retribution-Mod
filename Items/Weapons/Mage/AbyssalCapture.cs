...
{
	public class AbyssalCapture : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Abyssal Capture");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<AbyssalVortex>();
			item.shootSpeed = 6f;
			item.mana = 8;
		}
	}
	public class AbyssalVortex : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Dust dust;
                dust = Main.dust[Terraria.Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.Shadowflame, 0f, 0f, 0, new Color(255, 0, 201), 2.5f)];
                dust.noGravity = true;
            }
        }
        ...
        public override void AI()
        {
            ...
            Dust dust;
            dust = Main.dust[Terraria.Dust.NewDust(projectile.position, 60, 60, DustID.Shadowflame, 0f, 0f, 0, new Color(255, 255, 255), 1.710526f)];
            dust.noGravity = true;

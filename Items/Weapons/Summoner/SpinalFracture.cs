...
{
    public class SpinalFracture : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Spinal Fracture");
        }
    ...
    public class spinalfractureproj : ModProjectile
    {
        public const float whipLength = 50f;

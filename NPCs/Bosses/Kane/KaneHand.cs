...
namespace Retribution.NPCs.Bosses.Kane
{
    public class KaneHand : ModNPC
    {
        ...
        public Kane Head
        {
            get
            {
                return (Kane)Main.npc[(int)npc.ai[0]].modNPC;
            }
        }
        ...
        public override void AI()
        {
            ...
            if (!headNPC.active || headNPC.type != mod.NPCType("Kane"))
            {
                npc.active = false;
                return;
            }
        ...
        {
            Vector2 target = Head.npc.Bottom + new Vector2(Direction * 180f, 64f);
        ...
        private void HammerAttack()
        {
            ...
            if (attackTimer % 20 == 0 && attackTimer < 100 && Main.netMode != 1)
            {
                ...
                Projectile.NewProjectile(npc.Center, Vector2.Zero, mod.ProjectileType("KaneHammer"), damage, 6f, Main.myPlayer, npc.whoAmI);
            }
        }
        ...
        private void BladeAttack()
        {
            ...
            {
                NPC.NewNPC((int)npc.Bottom.X, (int)npc.Bottom.Y, mod.NPCType("KaneOrb"), 0, 2f, npc.whoAmI, 0f, 0f, npc.target);
            }
        }
        ...
        private void WispAttack()
        {
            ...
            if (AttackTimer == -240f && Main.netMode != 1)
            {
                NPC.NewNPC((int)npc.Bottom.X, (int)npc.Bottom.Y, mod.NPCType("KaneOrb"), 0, 1f, npc.whoAmI, 0f, 0f, npc.target);
            }
        }
        ...
        private void CreateDust()
        {
            ...
            for (float k = 0f; k < length - 10f; k += 4f)
            {
                ...
                {
                    int dust = Dust.NewDust(npc.Center + offset * k, 0, 0, mod.DustType("Kane"));

    ...
    public class KaneSoul : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (npc.ai[0] >= 900)
            {
                ...
                if (Main.netMode != 1)
                {
                    NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y + 40, mod.NPCType("Kane"), 0, 0f, 0f, 0f, 0f, npc.target);
                }
            }
            npc.rotation += 0.1f;
        }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            texture = mod.GetTexture("NPCs/Bosses/Kane/KaneSoulAura");

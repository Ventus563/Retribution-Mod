        ...
        public override void AI()
        {
            ...
            if (bulletTimer >= 180 && Main.rand.NextFloat() < .25f)
            {
                if (sideRight == true)
                {
                    ...
                    Projectile.NewProjectile(npc.Center.X, npc.Center.Y, Main.rand.Next(4, 10), -2, ModContent.ProjectileType<LightningBolt>(), 20, 0f, Main.myPlayer, npc.whoAmI, 100);
                    Projectile.NewProjectile(npc.Center.X, npc.Center.Y, Main.rand.Next(4, 10), 0, ModContent.ProjectileType<LightningBolt>(), 20, 0f, Main.myPlayer, npc.whoAmI, 100);
                    Projectile.NewProjectile(npc.Center.X, npc.Center.Y, Main.rand.Next(4, 10), 2, ModContent.ProjectileType<LightningBolt>(), 20, 0f, Main.myPlayer, npc.whoAmI, 100);
                ...
                else
                {
                    ...
                    Projectile.NewProjectile(npc.Center.X, npc.Center.Y, Main.rand.Next(-10, -4), 2, ModContent.ProjectileType<LightningBolt>(), 20, 0f, Main.myPlayer, npc.whoAmI, 100);
                    Projectile.NewProjectile(npc.Center.X, npc.Center.Y, Main.rand.Next(-10, -4), 0, ModContent.ProjectileType<LightningBolt>(), 20, 0f, Main.myPlayer, npc.whoAmI, 100);
                    Projectile.NewProjectile(npc.Center.X, npc.Center.Y, Main.rand.Next(-10, -4), -2, ModContent.ProjectileType<LightningBolt>(), 20, 0f, Main.myPlayer, npc.whoAmI, 100);
            ...
            if (stateEnraged2 == true)
            {
                ...
                if (bulleHellTimer > 300 && Main.rand.NextFloat() < .1f)
                {
                    ...
                    {
                        Projectile.NewProjectile(npc.Center.X, npc.Center.Y, Main.rand.Next(-10,10), Main.rand.Next(-10, 10), ModContent.ProjectileType<WindWaveLocus>(), 10, 0f, Main.myPlayer, npc.whoAmI, 100);
                        Projectile.NewProjectile(npc.Center.X, npc.Center.Y, Main.rand.Next(-10, 10), Main.rand.Next(-10, 10), ModContent.ProjectileType<WindWaveLocus>(), 10, 0f, Main.myPlayer, npc.whoAmI, 100);
                        Projectile.NewProjectile(npc.Center.X, npc.Center.Y, Main.rand.Next(-10, 10), Main.rand.Next(-10, 10), ModContent.ProjectileType<WindWaveLocus>(), 10, 0f, Main.myPlayer, npc.whoAmI, 100);

...
{
	internal class EarthHeadMin : EarthWorm
	{
		public override string Texture => "Retribution/NPCs/Bosses/Silva/EarthHeadMin";
	...
	internal class EarthBodyMin : EarthWorm
	{
		public override string Texture => "Retribution/NPCs/Bosses/Silva/EarthBodyMin";
	...
	internal class EarthTailMin : EarthWorm
	{
		public override string Texture => "Retribution/NPCs/Bosses/Silva/EarthTailMin";
	...
	public abstract class EarthWorm : Worm
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("EarthWorm");
		}
		...
		public override void Init()
		{
			minLength = 3;
			maxLength = 8;
			tailType = ModContent.NPCType<EarthTailMin>();
			bodyType = ModContent.NPCType<EarthBodyMin>();
			headType = ModContent.NPCType<EarthHeadMin>();
			speed = 6f;
			turnSpeed = 0.045f;
		}
	}

...
{
	internal class LeafHead : LeafWorm
	{
		public override string Texture => "Retribution/NPCs/Bosses/Silva/LeafHead";
	...
	internal class Leafbody : LeafWorm
	{
		public override string Texture => "Retribution/NPCs/Bosses/Silva/Leafbody";
	...
	internal class Leaftail : LeafWorm
	{
		public override string Texture => "Retribution/NPCs/Bosses/Silva/Leaftail";
	...
	public abstract class LeafWorm : Leafworm
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Leaf Worm");
		}
		...
		public override void Init()
		{
			minLength = 3;
			maxLength = 8;
			tailType = ModContent.NPCType<Leaftail>();
			bodyType = ModContent.NPCType<Leafbody>();
			headType = ModContent.NPCType<LeafHead>();
			speed = 8f;
			turnSpeed = 0.045f;
		}
	}
	public abstract class Leafworm : ModNPC
	{
		public bool head;
		public bool tail;

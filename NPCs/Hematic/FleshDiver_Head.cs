...
{
	internal class FleshDiver_Head : Fleshdiver
	{
		public override string Texture => "Retribution/NPCs/Hematic/Fleshdiver_Head";
	...
	internal class FleshDiver_Body : Fleshdiver
	{
		public override string Texture => "Retribution/NPCs/Hematic/Fleshdiver_Body";
	...
	internal class FleshDiver_Tail : Fleshdiver
	{
		public override string Texture => "Retribution/NPCs/Hematic/Fleshdiver_Tail";
	...
	public abstract class Fleshdiver : Worm
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Fleshdiver");
		}
		...
		public override void Init()
		{
			minLength = 10;
			maxLength = 15;
			tailType = ModContent.NPCType<FleshDiver_Tail>();
			bodyType = ModContent.NPCType<FleshDiver_Body>();
			headType = ModContent.NPCType<FleshDiver_Head>();
			speed = 10f;
			turnSpeed = 0.045f;
		}
	}

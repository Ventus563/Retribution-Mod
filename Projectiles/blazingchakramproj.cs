...
{
	public class blazingchakramproj : ModProjectile
	{
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            {
                Projectile.NewProjectile(target.Center, Vector2.Zero, ProjectileID.SolarWhipSwordExplosion, damage / 2, 6f);
            }
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Dust dust;
                dust = Main.dust[Terraria.Dust.NewDust(projectile.Center, projectile.width, projectile.height, 6, 0f, 0f, 0, new Color(255, 0, 201), 2.5f)];
                dust.noGravity = true;
            }
        }
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < NUM_DUSTS; i++)
            {
                ...
                dust = Main.dust[Terraria.Dust.NewDust(position, 30, 30, 6, 0f, 0f, 0, new Color(255, 255, 255), 1.710526f)];
                dust.noGravity = true;

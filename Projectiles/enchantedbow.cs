...
{
	public class enchantedbow : ModProjectile
	{
			...
			for (int i = 0; i < 200; i++)
			{
				...
				if (distance < 480f && !target.friendly && target.active)
				{
					if (projectile.ai[0] > 10f)
					{
						...
						shootToX *= distance * 5;
						shootToY *= distance * 5;
						int proj = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, shootToX, shootToY, ProjectileID.JestersArrow, 14, projectile.knockBack, Main.myPlayer, 0f, 0f);

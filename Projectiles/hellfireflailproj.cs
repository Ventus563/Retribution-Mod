...
{
	public class hellfireflailproj : ModProjectile
	{
		private const string ChainTexturePath = "Retribution/Projectiles/hellfireflailchain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Hellfire Chain-link");
		}
